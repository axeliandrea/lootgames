# lootgames/modules/menu_utama.py FINAL v5 (Pyrogram v2+)
import logging
import asyncio
...
OPEN_MENU_STATE = {}   # user_id: {"menu": menu_key, "message_id": id}
...
def make_keyboard(menu_key: str, user_id=None, page: int = 0) -> InlineKeyboardMarkup:
    ...
    if menu_key == "BBB" and user_id is not None:
        ...
        sorted_points = sorted(points.items(), key=lambda x: x[1]["points"], reverse=True)[:50]
